    ...
    public function index(Request $request, QueryService $queryService, Filesystem $filesystem): Response
    {
        ...
        if($form->isSubmitted() && $form->isValid()){
            try {
                ...
                $this->addFlash('contact-danger', 'Ihre Nachricht kann derzeit nicht zugestellt werden!' . $e);
            ...
            // render template
            return $this->renderForm('landingpage/index.html.twig',['form'=>$form,'showDownloadButton'=>$showDownloadButton]);
         ...
         *
         */
        return $this->renderForm('landingpage/index.html.twig',['showDownloadButton'=>$showDownloadButton,'form'=>$form,'hash'=>$this->hashService->getHash($request)]);
